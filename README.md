...
## Contents
- `scripts/` – preprocessing, training, evaluation, and plotting scripts
- `data/` – instructions for accessing the dataset
- `results/` – model outputs and generated results
- `LICENSE` – MIT License
...
3. Run the preprocessing, training, evaluation, and plotting scripts in the appropriate order.
